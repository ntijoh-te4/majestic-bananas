defmodule Mix.Tasks.Seed do
  ...
  defp seed_data() do
    ...
    Postgrex.query!(DB, "INSERT INTO students(student_name, student_url, school_id, class_id) VALUES($1, $2, $3, $4)", ["Tom Cruise", "/images/Tom.png", 1, 1], pool: DBConnection.ConnectionPool)
